  ...
  return (
    <>
      <section className="relative bg-white overflow-hidden">
        <NavBar />
        <div className="relative py-20 xl:pt-16 xl:pb-16 bg-white-900 max-w-screen-xl mx-auto">
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap items-center">
              <div className="w-full lg:w-1/2 mb-20 lg:mb-0">
                <h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight text-black font-bold tracking-tight">A small business is only as good as its tools.</h1>
                <p className="mb-8 text-lg md:text-xl leading-7 text-gray-400 font-medium">Lorem ipsum dolor sit amet, consectetur adipisng.</p>
                <ul>
                  <li className="mb-6 flex items-center">
                    ...
                    <p className="text-lg md:text-xl leading-7 text-gray-400 font-medium">Lorem ipsum dolor sit amet, consectetur adipisng.</p>
                  </li>
                  <li className="mb-6 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-circle-check" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <p className="text-lg md:text-xl leading-7 text-gray-400 font-medium">Suspendisse mollis tincidunt</p>
                  </li>
                  <li className="flex items-center">
                    ...
                    <p className="text-lg md:text-xl leading-7 text-gray-400 font-medium">Praesent varius justo vel justo pulvinar</p>
                  </li>
                </ul>
              </div>
              <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center p-10 xl:px-24 xl:pb-12 bg-white lg:max-w-xl lg:ml-auto rounded-4xl shadow-2xl">
                  ...
                  <h2 className="mb-4 text-2xl md:text-3xl text-gray-900 font-bold text-center">Join our community</h2>
                  <h3 className="mb-7 text-base md:text-lg text-gray-500 font-medium text-center">Start your free trial</h3>
                  <label className="mb-4 flex flex-col w-full">
                    <span className="mb-1 text-gray-800 font-medium">Email</span>
                    <input className="py-3 px-3 leading-5 w-full text-gray-400 font-normal border border-gray-200 outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-lg shadow-sm" type="text" placeholder="Enter your email address" />
                  </label>
                  <a className="mb-4 inline-block py-3 px-7 w-full leading-6 text-green-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md" href="#">Get Started</a>
                  <div className="flex items-center mb-4 w-full text-xs text-gray-400">
                    <div className="flex-1 h-px bg-gray-100"></div>
                    <span className="px-2 font-medium">OR</span>
                    <div className="flex-1 h-px w-24 bg-gray-100"></div>
                  </div>
                  <a onClick={() =>  signIn("google")} className="mb-4 w-full text-gray-500 hover:text-gray-600 font-medium text-center border border-gray-200 hover:border-gray-300 rounded-md shadow-sm" href="#">
                  ...
                  <p className="text-sm text-gray-400 font-medium text-center">
                    ...
                    <a className="text-green-500 hover:text-green-600" href="#">Sign In</a>
                  </p>
                </div>
              </div>
            </div>
